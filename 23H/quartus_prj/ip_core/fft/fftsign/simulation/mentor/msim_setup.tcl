...
# ----------------------------------------
# If fftsign is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.0 614 win32 2026.01.19.15:16:46
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/quartus18.0/quartus/"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/fftsign_fft_ii_0_3n1024sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fftsign_fft_ii_0_1n1024cos.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fftsign_fft_ii_0_2n1024cos.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fftsign_fft_ii_0_1n1024sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fftsign_fft_ii_0_2n1024sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fftsign_fft_ii_0_3n1024cos.hex ./
}
...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fftsign_fft_ii_0.sv"                                -work fft_ii_0
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/fftsign.v"                                                                   
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L fft_ii_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L fft_ii_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
