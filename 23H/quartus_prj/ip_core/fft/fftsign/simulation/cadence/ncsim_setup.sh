...
TOP_LEVEL_NAME="fftsign"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="D:/quartus18.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/fftsign_fft_ii_0_3n1024sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/fftsign_fft_ii_0_1n1024cos.hex ./
  cp -f $QSYS_SIMDIR/submodules/fftsign_fft_ii_0_2n1024cos.hex ./
  cp -f $QSYS_SIMDIR/submodules/fftsign_fft_ii_0_1n1024sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/fftsign_fft_ii_0_2n1024sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/fftsign_fft_ii_0_3n1024cos.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fftsign_fft_ii_0.sv"                       -work fft_ii_0 -cdslib ./cds_libs/fft_ii_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/fftsign.v"                                                                                              
fi
